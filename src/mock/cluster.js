...
export const nodes = [
  ...
  { name: 'worker-node-01', status: 'Ready', roles: 'worker', version: 'v1.28.2', cpu: 45, memory: 58, os: 'Ubuntu 22.04', kernel: '5.15.0', ip: '10.0.1.11', age: '245d',
    conditions: { Ready: true, DiskPressure: false, MemoryPressure: false, PIDPressure: false },
    externalIp: '203.0.113.11', containerRuntime: 'containerd://1.6.18', containerRuntimeShort: '1.6.18', arch: 'amd64', osType: 'linux',
    taints: [], taintCount: 0,
    podCIDR: '10.42.1.0/24', podCapacity: 110, podAllocatable: 110,
    usedCpu: 3600, allocCpu: 8000, usedMem: 19461571, allocMem: 33554432 },
  { name: 'worker-node-02', status: 'Ready', roles: 'worker', version: 'v1.28.2', cpu: 62, memory: 71, os: 'Ubuntu 22.04', kernel: '5.15.0', ip: '10.0.1.12', age: '245d',
    conditions: { Ready: true, DiskPressure: false, MemoryPressure: false, PIDPressure: false },
    externalIp: null, containerRuntime: 'containerd://1.6.18', containerRuntimeShort: '1.6.18', arch: 'amd64', osType: 'linux',
    taints: [], taintCount: 0,
    podCIDR: '10.42.2.0/24', podCapacity: 110, podAllocatable: 110,
    usedCpu: 4960, allocCpu: 8000, usedMem: 23823647, allocMem: 33554432 },
  { name: 'worker-node-03', status: 'Ready', roles: 'worker', version: 'v1.28.2', cpu: 38, memory: 45, os: 'Ubuntu 22.04', kernel: '5.15.0', ip: '10.0.1.13', age: '180d',
    conditions: { Ready: true, DiskPressure: false, MemoryPressure: false, PIDPressure: false },
    externalIp: null, containerRuntime: 'containerd://1.6.18', containerRuntimeShort: '1.6.18', arch: 'arm64', osType: 'linux',
    taints: [], taintCount: 0,
    podCIDR: '10.42.3.0/24', podCapacity: 110, podAllocatable: 110,
    usedCpu: 3040, allocCpu: 8000, usedMem: 15099494, allocMem: 33554432 },
  { name: 'worker-node-04', status: 'Ready', roles: 'worker', version: 'v1.28.2', cpu: 78, memory: 82, os: 'Ubuntu 22.04', kernel: '5.15.0', ip: '10.0.1.14', age: '180d',
    conditions: { Ready: true, DiskPressure: true, MemoryPressure: false, PIDPressure: false },
    externalIp: null, containerRuntime: 'containerd://1.6.18', containerRuntimeShort: '1.6.18', arch: 'amd64', osType: 'linux',
    taints: [], taintCount: 0,
    podCIDR: '10.42.4.0/24', podCapacity: 110, podAllocatable: 110,
    usedCpu: 6240, allocCpu: 8000, usedMem: 27514635, allocMem: 33554432 },
  { name: 'worker-node-05', status: 'Ready', roles: 'worker', version: 'v1.28.2', cpu: 51, memory: 63, os: 'Ubuntu 22.04', kernel: '5.15.0', ip: '10.0.1.15', age: '120d',
    conditions: { Ready: true, DiskPressure: false, MemoryPressure: false, PIDPressure: false },
    externalIp: null, containerRuntime: 'containerd://1.6.18', containerRuntimeShort: '1.6.18', arch: 'amd64', osType: 'linux',
    taints: [], taintCount: 0,
    podCIDR: '10.42.5.0/24', podCapacity: 110, podAllocatable: 110,
    usedCpu: 4080, allocCpu: 8000, usedMem: 21139292, allocMem: 33554432 },
  { name: 'worker-node-06', status: 'NotReady', roles: 'worker', version: 'v1.28.2', cpu: null, memory: null, os: 'Ubuntu 22.04', kernel: '5.15.0', ip: '10.0.1.16', age: '120d',
    conditions: { Ready: false, DiskPressure: false, MemoryPressure: true, PIDPressure: false },
    externalIp: null, containerRuntime: 'containerd://1.6.18', containerRuntimeShort: '1.6.18', arch: 'arm64', osType: 'linux',
    taints: [{ key: 'node.kubernetes.io/unreachable', effect: 'NoExecute' }], taintCount: 1,
    podCIDR: '10.42.6.0/24', podCapacity: 110, podAllocatable: 110,
    usedCpu: null, allocCpu: 8000, usedMem: null, allocMem: 33554432 },
  { name: 'gpu-node-01', status: 'Ready', roles: 'worker', version: 'v1.28.2', cpu: 34, memory: 52, os: 'Ubuntu 22.04', kernel: '5.15.0', ip: '10.0.1.20', age: '90d',
    conditions: { Ready: true, DiskPressure: false, MemoryPressure: false, PIDPressure: false },
    externalIp: null, containerRuntime: 'containerd://1.6.18', containerRuntimeShort: '1.6.18', arch: 'amd64', osType: 'linux',
    taints: [{ key: 'nvidia.com/gpu', value: 'present', effect: 'NoSchedule' }], taintCount: 1,
    podCIDR: '10.42.7.0/24', podCapacity: 110, podAllocatable: 110,
    usedCpu: 5440, allocCpu: 16000, usedMem: 34896609, allocMem: 67108864 },
]
