...
const pvcQ = useResourceList({ key: ['cluster', cid, 'pvcs'], fetcher: () => store.fetchPVCs(), options: { refetchInterval: 30000 } })
const pvQ = useResourceList({ key: ['cluster', cid, 'pvs'], fetcher: () => store.fetchPVs(), options: { refetchInterval: 30000 } })
