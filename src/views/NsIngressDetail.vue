      ...
      <div class="lg:col-span-4 flex flex-col gap-sm">
          ...
          <div class="divide-y divide-outline-variant/15">
            <div class="px-md py-2 flex items-center justify-between gap-sm">
              ...
              <div class="flex items-center gap-xs min-w-0">
                ...
                <button @click="openClassEditor" class="p-0.5 text-on-surface-variant hover:text-primary rounded shrink-0 max-sm:p-2 max-sm:-m-2" :title="$t('ns.ingressDetail.editClassTitle')"><span class="material-symbols-outlined text-base">edit</span></button>
              </div>
            </div>
            <div class="px-md py-2 flex items-center justify-between gap-sm">
              ...
              <div class="flex items-center gap-xs">
                ...
                <button @click="openTlsEditor" class="p-0.5 text-on-surface-variant hover:text-primary rounded shrink-0 max-sm:p-2 max-sm:-m-2" :title="$t('ns.ingressDetail.editTlsTitle')"><span class="material-symbols-outlined text-base">edit</span></button>
              </div>
            </div>
        ...
        <div class="rounded-xl overflow-hidden bg-surface-container-lowest border border-outline-variant">
          <div class="px-md py-2 border-b border-outline-variant/50 flex items-center gap-sm">
            ...
            <button @click="showAddLabelModal = true" class="p-0.5 text-on-surface-variant hover:text-primary rounded max-sm:p-2 max-sm:-m-2" :title="$t('ns.ingressDetail.addLabel')"><span class="material-symbols-outlined text-base">add</span></button>
          </div>
          <div class="p-sm flex flex-wrap gap-xs">
        ...
        <div class="rounded-xl overflow-hidden bg-surface-container-lowest border border-outline-variant">
          <div class="px-md py-2 border-b border-outline-variant/50 flex items-center gap-sm">
            ...
            <button @click="showAddAnnModal = true" class="p-0.5 text-on-surface-variant hover:text-primary rounded max-sm:p-2 max-sm:-m-2" :title="$t('ns.ingressDetail.addAnnotation')"><span class="material-symbols-outlined text-base">add</span></button>
          </div>
            ...
            <div v-for="([key, val], idx) in allAnnotations" :key="idx" class="px-md py-1.5 group">
              <div class="flex items-center justify-between gap-xs">
                ...
                <div class="flex gap-0.5 shrink-0 opacity-0 group-hover:opacity-100 max-sm:opacity-100 transition-opacity">
                  <button v-if="editingAnn !== key" @click="startEditAnn(key)" class="p-0.5 text-on-surface-variant hover:text-primary rounded max-sm:p-1.5 max-sm:-m-1.5"><span class="material-symbols-outlined text-sm">edit</span></button>
                  <button @click="deleteAnnotation(key)" class="p-0.5 text-on-surface-variant hover:text-error rounded max-sm:p-1.5 max-sm:-m-1.5"><span class="material-symbols-outlined text-sm">delete</span></button>
                </div>
              </div>
