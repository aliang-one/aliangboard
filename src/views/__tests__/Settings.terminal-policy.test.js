...
beforeEach(() => {
  ...
  // W4 OIDC 配置卡同挂载拉取(安全 tab 第四卡):同上,网络零触达
  vi.spyOn(adminApi.oidcConfig, 'get').mockResolvedValue({ enabled: false, issuer: '', clientId: '', scopes: '', groupsClaim: '', usernameClaim: '', hasSecret: false, redirectUri: '' })
})
