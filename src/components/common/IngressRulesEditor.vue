    ...
    <div v-for="(h, hi) in modelValue" :key="hi" class="rounded-lg border border-outline-variant overflow-hidden">
      <div class="px-sm py-1.5 bg-surface-container-low flex items-center gap-xs">
        ...
        <div class="flex items-center gap-0.5 shrink-0">
          <button @click="moveHost(hi, -1)" :disabled="hi === 0" class="p-0.5 text-on-surface-variant hover:text-primary disabled:opacity-30 rounded relative max-sm:after:absolute max-sm:after:-inset-2 max-sm:after:content-['']" :title="t('ns.ingressDetail.moveUpHost')"><span class="material-symbols-outlined text-base">arrow_upward</span></button>
          <button @click="moveHost(hi, 1)" :disabled="hi === modelValue.length - 1" class="p-0.5 text-on-surface-variant hover:text-primary disabled:opacity-30 rounded relative max-sm:after:absolute max-sm:after:-inset-2 max-sm:after:content-['']" :title="t('ns.ingressDetail.moveDownHost')"><span class="material-symbols-outlined text-base">arrow_downward</span></button>
          <button @click="duplicateHost(hi)" class="p-0.5 text-on-surface-variant hover:text-primary rounded relative max-sm:after:absolute max-sm:after:-inset-2 max-sm:after:content-['']" :title="t('ns.ingressDetail.dupHost')"><span class="material-symbols-outlined text-base">content_copy</span></button>
          <button @click="removeHost(hi)" class="p-0.5 text-on-surface-variant hover:text-error rounded relative max-sm:after:absolute max-sm:after:-inset-2 max-sm:after:content-['']" :title="t('ns.ingressDetail.removeHost')"><span class="material-symbols-outlined text-base">delete</span></button>
        </div>
      </div>
      <div class="p-sm flex flex-col gap-xs">
        <div v-for="(p, i) in h.paths" :key="i" class="flex gap-xs items-center flex-wrap">
          ...
          <div class="flex items-center gap-0.5 shrink-0">
            <button @click="movePath(hi, i, -1)" :disabled="i === 0" class="p-0.5 text-on-surface-variant hover:text-primary disabled:opacity-30 rounded relative max-sm:after:absolute max-sm:after:-inset-2 max-sm:after:content-['']" :title="t('ns.ingressDetail.moveUpPath')"><span class="material-symbols-outlined text-base">arrow_upward</span></button>
            <button @click="movePath(hi, i, 1)" :disabled="i === h.paths.length - 1" class="p-0.5 text-on-surface-variant hover:text-primary disabled:opacity-30 rounded relative max-sm:after:absolute max-sm:after:-inset-2 max-sm:after:content-['']" :title="t('ns.ingressDetail.moveDownPath')"><span class="material-symbols-outlined text-base">arrow_downward</span></button>
            <button @click="duplicatePath(hi, i)" class="p-0.5 text-on-surface-variant hover:text-primary rounded relative max-sm:after:absolute max-sm:after:-inset-2 max-sm:after:content-['']" :title="t('ns.ingressDetail.dupPath')"><span class="material-symbols-outlined text-base">content_copy</span></button>
            <button @click="removePath(hi, i)" class="p-0.5 text-on-surface-variant hover:text-error rounded relative max-sm:after:absolute max-sm:after:-inset-2 max-sm:after:content-['']" :title="t('ns.ingressDetail.removePath')"><span class="material-symbols-outlined text-base">delete</span></button>
          </div>
        </div>
