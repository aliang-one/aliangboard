...
// ── 漏译守卫(issue #10,2026-09-23):zh 值与 en 值同文且含英文单词 = 疑似漏译 ──
// 政策:K8s 原生语汇(资源种类名/字段名/枚举值/YAML/占位符示例)/品牌名/单位刻意双语同文,
// 显式登记在 UNTRANSLATED_ALLOW(逐键名单,注释在 git blame);其余业务与通用 UI 词汇必须翻译。
// 判定宽松(值含任意 CJK 即算已译,如「reconcile:成功 {n} 个」),把红灯留给纯英文残留。
const UNTRANSLATED_ALLOW = new Set([
  'admin.clusters.authKubeconfig',
  'admin.clusters.authToken',
  'admin.crdList.crdsLabel',
  'admin.crdList.thKind',
  'admin.ingressClasses.controllerPlaceholder',
  'admin.ingressClasses.namePlaceholder',
  'admin.ingressClasses.paramsKind',
  'admin.llm.exDeepSeekLabel',
  'admin.llm.exOpenAILabel',
  'admin.oidc.groupsClaim',
  'admin.oidc.scopes',
  'admin.oidc.usernameClaim',
  'admin.priorityClasses.namePlaceholder',
  'admin.runtimeClasses.handlerLabel',
  'admin.runtimeClasses.handlerPlaceholder',
  'admin.runtimeClasses.namePlaceholder',
  'admin.runtimeClasses.thHandler',
  'adminState.ttl',
  'auditTrail.sourceAgent',
  'auditTrail.sourceMcp',
  'certs.thCertManager',
  'certs.thName',
  'cols.ingress.tls',
  'cols.nodes.cpu',
  'cols.rbac._t',
  'common.cpu',
  'component.clusterForm.apiServer',
  'component.clusterForm.bearerToken',
  'component.createConfigModal.tabYaml',
  'component.resourceCard.clusterIP',
  'component.resourceCard.podIP',
  'component.volumeMount.subPathLabel',
  'config.configmapsTab',
  'config.cpuTarget',
  'config.hpasTab',
  'config.limitrangesTab',
  'config.resourcequotasTab',
  'config.secretsTab',
  'deploy.ced.envFromCmLabel',
  'deploy.ced.envFromSecretLabel',
  'deploy.ced.probeTypeExec',
  'deploy.ced.probeTypeHttp',
  'deploy.ced.probeTypeTcp',
  'deploy.ced.runAsGroup',
  'deploy.ced.runAsUser',
  'deploy.ced.stdinLabel',
  'deploy.envFrom',
  'deploy.externalName',
  'deploy.ingressClass',
  'deploy.postStart',
  'deploy.preStop',
  'ingressController.haproxy.label',
  'ingressController.kong.label',
  'ingressController.nginx-ingress.label',
  'ingressController.traefik.label',
  'ingressPerf.unitKbPerSec',
  'login.title',
  'monitoring.cpuTab',
  'nav.crds',
  'network.tabEndpoints',
  'network.tabIngress',
  'network.tabNetworkPolicies',
  'network.tabServices',
  'nodeDetail.kubelet',
  'nodeDetail.podCidr',
  'nodeDetail.pods',
  'ns.cmDetail.tabYaml',
  'ns.configmaps.tabYaml',
  'ns.configmaps.title',
  'ns.endpoints.title',
  'ns.ingressDetail.ingress',
  'ns.ingressDetail.ingressClass',
  'ns.ingressDetail.labelPlaceholder',
  'ns.ingressDetail.labelValuePlaceholder',
  'ns.ingressDetail.tls',
  'ns.ingressDetail.tlsRowLabel',
  'ns.ingressDetail.tlsSecret',
  'ns.ingressDetail.tlsSecretPlaceholder',
  'ns.ingressDetail.yaml',
  'ns.ingress.thTls',
  'ns.ingress.title',
  'ns.ingress.valuePlaceholder',
  'ns.namespaceOverview.relatedIngress',
  'ns.namespaceOverview.relatedService',
  'ns.namespaces.labelsPlaceholder',
  'ns.namespaces.namePlaceholder',
  'ns.netpolCreate.matchExpressions',
  'ns.netpolDetail.networkPolicies',
  'ns.netpolDetail.networkPolicy',
  'ns.networkPolicies.thName',
  'ns.networkPolicies.title',
  'ns.nsDetail.pods',
  'ns.nsDetail.services',
  'ns.pdb.maxUnavailableLabel',
  'ns.pdb.minAvailableLabel',
  'ns.pdb.thSelector',
  'ns.pods.title',
  'ns.pvcDetail.capacityPlaceholder',
  'ns.pvcDetail.storageClassPlaceholder',
  'ns.pvcDetail.title',
  'ns.rbac.clusterRoleBindingsTab',
  'ns.rbac.clusterRoleLabel',
  'ns.rbac.clusterRolesTab',
  'ns.rbac.roleBindingsTab',
  'ns.rbac.rolesTab',
  'ns.rbac.serviceAccountsTab',
  'ns.rbac.title',
  'ns.resourceQuotaDetail.quotaConfigMaps',
  'ns.resourceQuotaDetail.quotaPods',
  'ns.resourceQuotaDetail.quotaPvc',
  'ns.resourceQuotaDetail.quotaReplicationControllers',
  'ns.resourceQuotaDetail.quotaResourceQuotas',
  'ns.resourceQuotaDetail.quotaSecrets',
  'ns.resourceQuotaDetail.quotaServices',
  'ns.resourceQuotas.thCpu',
  'ns.resourceQuotas.thPods',
  'ns.resourceQuotas.title',
  'ns.roleBindingDetail.clusterRole',
  'ns.roleBindingDetail.namePlaceholder',
  'ns.roleBindingDetail.rbac',
  'ns.roleBindingDetail.role',
  'ns.roleBindingDetail.roleBinding',
  'ns.roleDetail.apiGroupsLabel',
  'ns.roleDetail.kindLabel',
  'ns.roleDetail.roleKind',
  'ns.saDetail.imagePullSecretsPlaceholder',
  'ns.saDetail.rbac',
  'ns.saDetail.serviceAccount',
  'ns.secretDetail.tabYaml',
  'ns.secrets.tabYaml',
  'ns.secrets.title',
  'ns.services.endpoints',
  'ns.services.extNameReq',
  'ns.services.thClusterIp',
  'ns.services.thExternalIp',
  'ns.services.title',
  'ns.storage.pending',
  'ns.storage.pvcTab',
  'ns.storage.storageClass',
  'ns.storage.storageClassTab',
  'ns.storage.thProvisioner',
  'ns.storage.thStorageClass',
  'ns.svcDetail.externalNamePlaceholder',
  'ns.svcDetail.yamlTitle',
  'ns.workloads.daemonSets',
  'ns.workloads.deployments',
  'ns.workloads.jobs',
  'ns.workloads.statefulSets',
  'podDetail.pod',
  'rbac.canI.namespacePlaceholder',
  'rbac.canI.serverResultSubtitle',
  'rbac.canI.subjectNamePlaceholder',
  'rbac.clusterRoleBindingsTab',
  'rbac.rolesTab',
  'rbac.serviceAccountsTab',
  'rbac.thRoleName',
  'rbac.title',
  'route.apiServices',
  'route.csiNodes',
  ...
  'route.rbac',
  'route.replicaSets',
  'secretTemplate.gitScopeGithub',
  'secretTemplate.gitScopeGitlab',
  'settings.apiServer',
  'settings.apiServerProbe',
  'settings.authMethod',
  'settings.tabs.api',
  'storage.capacityPlaceholder',
  'storage.default',
  'storage.familyNfs',
  'storage.parametersPlaceholder',
  'storage.pending',
  'storage.presets.aws-ebs.label',
  'storage.presets.azure-disk.label',
  'storage.presets.cephfs.label',
  'storage.presets.ceph-rbd.label',
  'storage.presets.gce-pd.label',
  'storage.presets.local-path.label',
  'storage.presets.longhorn.label',
  'storage.presets.openebs-localpv.label',
  'storage.presets.topolvm.label',
  'storage.provisioner',
  'storage.provisionerPlaceholder',
  'storage.pvcPlaceholder',
  'storage.pvcTab',
  'storage.pvPlaceholder',
  'storage.readOnlyMany',
  'storage.readWriteMany',
  'storage.readWriteOnce',
  'storage.readWriteOncePod',
  'storage.recycle',
  'storage.retain',
  'storage.scPlaceholder',
  'storage.storageClass',
  'storage.storageClassTab',
  'storage.tabs.pv',
  'storage.tabs.pvc',
  'storage.tabs.sc',
  'storage.thProvisioner',
  'storage.thStorageClass',
  'transfers.progressLabel',
  'transfers.speedLabel',
  'userCenter.langEn',
  'userCenter.mfa.otpauthLabel',
  'workbench.card.manifests',
  'workbench.chat.roleAgent',
  'workbench.credentials.presetSsh',
  'workbench.detail.newFilePlaceholder',
  'workbench.detail.reconcile',
  'workbench.detail.reconciling',
  'workbench.ledger.bootstrap',
  'workbench.ledger.fileItem',
  'workbench.pill.ssh',
  'workbench.records.auditRowAi',
  'workbench.records.auditRowMcp',
  'workloadDetail.imageLabel',
  'workloadDetail.namespaceLabel',
  'workloadDetail.replicasLabel',
  'workloadDetail.revisionLabel',
  'workloadDetail.typeLabel',
  'workload.edit.priorityClass',
  'workload.expose.nodePort',
  'workload.ingressMap.service',
  'workload.meta.descHint',
  'workload.podDetail.terminalAttach',
  'workload.podDetail.terminalExec',
  'workload.podList.pods',
  'workload.tabs.yaml',
  'workload.topology.pods',
  'workload.topology.service',
])

export function untranslatedValues(zhMsgs, enMsgs) {
  const zh = zhMsgs || loadJson('../src/locales/zh.json')
  const en = enMsgs || loadJson('../src/locales/en.json')
  const get = (o, k) => k.split('.').reduce((a, c) => (a == null ? a : a[c]), o)
  const out = []
  for (const k of flat(zh)) {
    ...
    if (z !== e) continue                          // 两语不同 → 已译
    if (/[一-鿿]/.test(z)) continue        // 同文但含中文 → 视作有意混排
    if (!/[A-Za-z]{2,}/.test(z)) continue          // 纯符号/数字/单位
    if (UNTRANSLATED_ALLOW.has(k)) continue        // 刻意保留(K8s 原生/品牌/占位符)
    out.push({ key: k, value: z.slice(0, 60) })
  }
  return out
}
...
if (import.meta.url === pathToFileURL(process.argv[1]).href) {
  ...
  const untranslated = untranslatedValues()
  console.log(`漏译值(zh==en 且含英文,不在豁免名单)：${untranslated.length}`)
  untranslated.slice(0, 20).forEach(v => console.log(`  ${v.key} = ${JSON.stringify(v.value)}`))
  process.exit(total > 0 || onlyZh.length || onlyEn.length || missing.length || dangling.length || dups.length || issues.length || untranslated.length ? 1 : 0)
}
