...
export const TABLE = {
  ...
  'wbc.messageTooLarge': { zh: '单条消息过长(上限约 {limitKB}KB)。大段日志/配置请用 @-引用资源 附带,或分段发送。', en: 'Message too large (limit ~{limitKB}KB). Attach large logs/configs via @-resource references, or send in parts.' },
